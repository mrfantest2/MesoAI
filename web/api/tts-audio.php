...
// Old already-prepared v6 files may have no metadata sidecar; those were all
// generated by the reviewed Meso A profile. New files always carry metadata.
$voiceProfile = 'meso-a';
$voiceLanguage = '';
if (is_file($metaPath) && is_readable($metaPath)) {
    ...
    if (!is_array($mediaMeta)
        ...
        || !in_array((string)($mediaMeta['profile'] ?? ''), ['meso-a','meso-v2'], true)) {
