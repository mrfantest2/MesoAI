...
.shell{min-height:100dvh;display:grid;grid-template-columns:260px minmax(0,1fr)}
.side{border-right:1px solid var(--line);padding:18px;background:rgba(8,10,16,.86);backdrop-filter:blur(16px);display:flex;flex-direction:column;gap:14px}
...
.panel{padding:14px;border:1px solid var(--line);border-radius:16px;background:var(--panel)}.label{font-size:11px;text-transform:uppercase;letter-spacing:.1em;color:var(--muted);font-weight:750}.status{display:flex;justify-content:space-between;gap:10px;margin-top:9px}.pill{border:1px solid var(--line);border-radius:999px;padding:4px 8px;font-size:11px;color:var(--muted)}.pill.good{color:var(--good);border-color:#315347}.pill.warn{color:var(--warn);border-color:#66552e}
...
.main{min-width:0;display:flex;flex-direction:column;min-height:100dvh}.top{height:64px;position:sticky;top:0;z-index:5;border-bottom:1px solid var(--line);background:rgba(7,8,13,.74);backdrop-filter:blur(16px);display:flex;align-items:center;padding:0 20px;gap:8px}.top strong{font-size:15px}.top span{margin-left:auto;color:var(--muted);font-size:12px}.installTop,.memoryTop{border:1px solid #654a8a;border-radius:10px;background:#1d1728;color:var(--txt);padding:7px 10px;cursor:pointer;white-space:nowrap}.memoryTop{border-color:#3f4d67;background:#151b27}
...
.installSheet{position:fixed;inset:0;z-index:30;display:grid;place-items:end center;background:rgba(0,0,0,.56);padding:16px}.installCard{width:min(520px,100%);position:relative;border:1px solid var(--line);border-radius:20px;background:linear-gradient(180deg,var(--panel2),var(--panel));padding:21px;box-shadow:0 30px 90px rgba(0,0,0,.48);margin-bottom:max(0px,env(safe-area-inset-bottom))}.installCard strong{display:block;font-size:19px;padding-right:38px}.installCard p{color:var(--muted);margin:9px 0 0;line-height:1.6}.installClose{position:absolute;right:12px;top:12px;width:34px;height:34px;border-radius:10px;border:1px solid var(--line);background:#171b27;color:var(--txt);cursor:pointer;font-size:20px}.memoryList{display:grid;gap:9px;max-height:min(52dvh,520px);overflow:auto;margin-top:14px}.memoryClear{width:100%;margin-top:14px;border:1px solid #693b45;border-radius:11px;padding:10px;background:#2a171c;color:#ffb0ba;cursor:pointer}
@media(min-width:761px){.installSheet{place-items:center}.installCard{margin-bottom:0}}
@media(max-width:760px){.shell{grid-template-columns:1fr}.side{display:none}.top{height:58px;padding:0 13px}.chat{padding:8px 8px calc(8px + env(safe-area-inset-bottom))}.messages{min-height:calc(100dvh - 220px);padding:16px 2px 10px}.msg{max-width:92%}.composeRow{grid-template-columns:auto minmax(0,1fr)}.send{grid-column:1/-1;width:100%}.top span{display:none}.installTop,.memoryTop{padding:7px 9px}.memoryTop{margin-left:auto}}
</style>
</head>
<body>
<?php if (!$authorized): ?>
...
<aside class="side">
  ...
  <div class="panel">
    ...
    <button class="installSide" data-install-app type="button" hidden aria-hidden="true" style="margin-top:8px">⬇ Install MesoAI app</button>
